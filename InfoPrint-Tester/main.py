...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Lightweight InfoPrint tester")
...
def main() -> None:
    ...
    table = Table(title="InfoPrint Scan Results", box=box.ROUNDED, show_lines=True, highlight=True)
    table.add_column("IP",         style="cyan", no_wrap=True)
    table.add_column("URL",        style="blue", no_wrap=True)
    table.add_column("InfoPrint?", justify="center")
