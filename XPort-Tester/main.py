...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Lightweight Lantronix XPort tester")
...
def main() -> None:
    ...
    table = Table(title="XPort Scan Results", box=box.ROUNDED, show_lines=True, highlight=True)
    table.add_column("IP",     style="cyan", no_wrap=True)
    table.add_column("URL",    style="blue", no_wrap=True)
    table.add_column("XPort?", justify="center")
